...
<body>
    ...
    <p>
        ...
        <shiro:hasRole name="NIO.Operator.dlo">NIO.Operator.dlo<br/></shiro:hasRole>
        <shiro:hasRole name="NIO.Operator.ovr">NIO.Operator.ovr<br/></shiro:hasRole>
        <shiro:hasRole name="group1">group1<br/></shiro:hasRole>
    </p>
    ...
    <p>
        ...
        <shiro:lacksRole name="NIO.Operator.dlo">NIO.Operator.dlo<br/></shiro:lacksRole>
    </p>
